...
# Rubble properties
export(bool) var is_walkable = true
export(Texture) var chunk_texture
export(int) var max_settle_time = 3.0
...
func get_top_position() -> Vector2:
	return global_position + Vector2(0, -sprite.texture.get_size().y / 2)